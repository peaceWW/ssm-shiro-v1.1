...
<script>
    layui.use(['table', 'element', 'jquery'], function () {
        ...
        table.on('tool(user)', function (obj) {
            var data = obj.data;
            if (obj.event === 'update') {
                window.location.href = '${pageContext.request.contextPath}/admin/role/update/' + data.roleId;
            }
            ...
            if (obj.event === 'delete') {
                ...
                layer.confirm('您确定要删除该角色吗？', {
                    ...
                    layer.closeAll();
                    $.post("${pageContext.request.contextPath}/admin/role/deleteRoleById", {roleId: roleId}, function (data) {
                        if (data == "success") {
                            //如果修改成功,则刷新页面
